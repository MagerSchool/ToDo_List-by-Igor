export function addTask (event, inputTask, taskBody) {
    event.preventDefault();
    const taskText = inputTask.value;
    const taskHTML = `
        <div id="task-${taskBody.children.length}" class="todo_list-item">
            <div class="todo_list-content_wrap">
                <strong>${taskBody.children.length}</strong>
                <span class="todo_list-text ">${taskText}</span>
            </div>
